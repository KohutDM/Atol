...
use Mmd\Atol\Task\Import\SellChequeImport as SellChequeImportTask;
 ...
 */
class SellChequeImport extends AbstractCron
{
    /**
    ...
    {
        $invoices = $this->exportHelper->getInvoicesByAtolStatus($this->atolHelper::STATUS_WAIT);
    ...
    {
        return 'atol/' . SellChequeImportTask::TASK_CODE;
    }
     ...
     * @return $this
     */
    protected function setCurrentInvoice(InvoiceInterface $invoice): SellChequeImport
    {
